...
const starInterval =
window.innerWidth < 768 ? 1200 : 700;

setInterval(createStar, starInterval);
...
window.innerWidth < 768 ? 5500 : 3500;
...
const totalStarsUniverse =

window.innerWidth < 768 ? 1400 : 2500;

for(let i=0;i<totalStarsUniverse;i++){
        stars.push({
